...
export function ClientListPage(props: ClientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getClients({
        relations: ['user', 'article.count', 'category.count', 'contributor.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('category', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('contributor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'contributor',
          header: 'Contributor',
          accessorKey: 'contributor',
          cell: ({ row: { original: record } }: any) => record?._count?.contributor,
        }
      : null,
