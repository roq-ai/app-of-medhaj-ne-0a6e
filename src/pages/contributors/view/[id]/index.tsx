...
import { getContributorById } from 'apiSdk/contributors';
import { ContributorInterface } from 'interfaces/contributor';

function ContributorViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('contributor', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/contributors/edit/${id}`} passHref legacyBehavior>
                    <Button
                ...
                <FormListItem
                  ...
                  text={
                    data?.last_contribution
                      ? format(parseISO(data?.last_contribution as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Total Contributions" text={data?.total_contributions} />
