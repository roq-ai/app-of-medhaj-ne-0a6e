...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'article.create': {
    roles: ['contributor'],
    key: 'new-article-created',
    tenantPath: ['client', 'article'],
    userPath: [],
  },
  'article.update': { roles: ['contributor'], key: 'article-updated', tenantPath: ['client', 'article'], userPath: [] },
  'article.delete': { roles: ['contributor'], key: 'article-deleted', tenantPath: ['client', 'article'], userPath: [] },
};

const ownerRoles: string[] = ['contributor'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['contributor'];
